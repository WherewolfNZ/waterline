  ...
  return parley(
    ...
    function (done){
      ...
      (function(proceed) {
        ...
        // if the beforeUpdate callback takes 3 args, then pass in "options" param
        if (WLModel._callbacks.beforeUpdate.length === 3) {
          WLModel._callbacks.beforeUpdate(
            query.valuesToSet,
            {
          ...
          // beforeUpdate takes 2 args, valuesToSet and proceed, like normal
